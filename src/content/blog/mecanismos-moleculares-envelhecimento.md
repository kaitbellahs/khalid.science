---
title: "Mecanismos Moleculares do Envelhecimento Humano: Dos Hallmarks à Senescência Negligenciável"
description: "Revisão narrativa sobre os 4 eixos mecanísticos centrais do envelhecimento (instabilidade genômica, senescência celular, desregulação metabólica, perda de proteostase), evidências de senescência negligenciável e o conceito de amortalidade."
date: 2026-03-01
tags: ["biogerontologia", "senescência celular", "hallmarks", "envelhecimento", "healthspan"]
lang: pt
draft: false
---
...
O envelhecimento biológico é redefinido pela biogerontologia contemporânea como o declínio progressivo da homeostase celular, mediado pelo acúmulo de dano molecular estocástico — processo cuja reversibilidade parcial já foi demonstrada em nível epigenético e molecular em modelos pré-clínicos. A presente revisão narrativa analisa os mecanismos moleculares fundamentais do envelhecimento humano sob o modelo dos *hallmarks* (López-Otín *et al.*, 2013; 2023), abrangendo: instabilidade genômica e atrito telomérico, senescência celular e o Fenótipo Secretor Associado à Senescência (SASP), desregulação metabólica do eixo mTOR/IGF-1, declínio autofágico e perda de proteostase. Examinam-se evidências de senescência negligenciável em *Turritopsis dohrnii*, *Hydra* sp. e *Heterocephalus glaber*, além da capacidade regenerativa em vertebrados e invertebrados, indicando que a mortalidade por senescência não constitui restrição biológica universal. Discute-se o conceito de amortalidade — ausência de declínio funcional intrínseco associado à idade, com manutenção da vulnerabilidade a causas externas — como horizonte translacional da *geroscience*. Conclui-se que os mecanismos do envelhecimento apresentam modulabilidade terapêutica e que intervenções geroprotectoras representam fronteira relevante para a extensão do período de vida saudável (*healthspan*).

**Palavras-chave:** Senescência celular; Biogerontologia; Hallmarks do envelhecimento; Senescência negligenciável; Healthspan.

---

## ABSTRACT

Biological aging is currently redefined by translational biogerontology as the progressive decline of cellular homeostasis, driven by the accumulation of stochastic molecular damage — a process whose partial reversibility has been demonstrated at the epigenetic and molecular level in pre-clinical models. This narrative review analyzes the fundamental molecular mechanisms of human aging through the hallmarks framework (López-Otín *et al.*, 2013; 2023). Core domains include: genomic instability and telomere attrition, cellular senescence coupled with the Senescence-Associated Secretory Phenotype (SASP), metabolic dysregulation of the mTOR/IGF-1 axis, autophagic insufficiency, and proteostatic failure. Evidence of negligible senescence in *Turritopsis dohrnii*, *Hydra* sp., and *Heterocephalus glaber*, alongside regenerative competence across taxa, indicates that senescence-induced mortality is not a universal biological constraint. The concept of amortality — the absence of intrinsic age-related functional decline while retaining exogenous vulnerability — is discussed as a translational horizon of modern geroscience. It is concluded that the mechanistic drivers of aging exhibit therapeutic modulability, and that geroprotective interventions represent a relevant frontier for extending the healthy lifespan (healthspan).

**Keywords:** Cellular senescence; Biogerontology; Hallmarks of aging; Negligible senescence; Healthspan.
...
Uma distinção fundamental na gerontologia contemporânea separa esses dois conceitos frequentemente confundidos. A extensão do *lifespan* sem correspondente ampliação do *healthspan* resulta em aumento da morbidade no período terminal de vida, com elevação dos índices de fragilidade, declínio neurocognitivo e dependência funcional (Garmany *et al.*, 2021). As intervenções geroprotectoras contemporâneas não buscam simplesmente estender a duração da vida, mas preservar a funcionalidade biológica do organismo em uma faixa de máxima capacidade pelo período mais longo possível (Rando; Wyss-Coray, 2021).

Paralelamente, um conjunto crescente de evidências biológicas demonstra que o envelhecimento não é universal na natureza. Múltiplos organismos desenvolveram mecanismos de senescência negligenciável, regeneração completa ou reversão do ciclo de vida — sugerindo que, em determinados taxa, a mortalidade biológica por envelhecimento constitui fenômeno potencialmente modificável. Contudo, as teorias evolutivas clássicas — pleiotropia antagônica (Williams, 1957), soma descartável (Kirkwood, 1977) e acúmulo de mutações (Medawar, 1952) — indicam que a prevalência do envelhecimento nos metazoários resulta de pressões seletivas específicas, e não de uma restrição termodinâmica absoluta.

O presente artigo de revisão narrativa tem por **objetivo geral** analisar os mecanismos moleculares fundamentais do envelhecimento humano e as evidências de sua modulabilidade. Seus **objetivos específicos** incluem: (i) revisar os quatro eixos mecanísticos centrais do envelhecimento celular (instabilidade genômica e atrito telomérico, senescência celular e SASP, desregulação metabólica e autofagia, e perda de proteostase); (ii) examinar as evidências de senescência negligenciável e regeneração na natureza; (iii) revisar a evolução da longevidade humana e o conceito de amortalidade; e (iv) avaliar o estado translacional das intervenções geroprotectoras em desenvolvimento. Dentre os doze *hallmarks* propostos por López-Otín *et al.* (2023), a presente revisão concentra-se nos quatro eixos supracitados por constituírem os domínios com maior volume de evidências translacionais e alvos farmacológicos em estágio clínico. Os demais *hallmarks* — incluindo alterações epigenéticas, disfunção mitocondrial como categoria independente, exaustão de células-tronco, comunicação intercelular alterada e disbiose — não são abordados em profundidade, constituindo objeto potencial de revisões complementares.

A **justificativa** reside na escassez de revisões em língua portuguesa que integrem, de forma abrangente, os *hallmarks* do envelhecimento com as evidências de senescência negligenciável e as perspectivas farmacológicas emergentes, oferecendo ao leitor lusófono uma visão panorâmica e atualizada deste campo em expansão.
...
**Declaração de uso de IA:** Ferramentas de inteligência artificial generativa (Claude, Anthropic; Gemini, Google DeepMind) foram utilizadas como auxiliares em três etapas específicas: (a) organização da estrutura temática do manuscrito; (b) revisão linguística e adequação ao registro acadêmico; e (c) verificação de formatação das referências em norma ABNT. A seleção bibliográfica, a análise crítica do conteúdo e a formulação dos argumentos foram realizadas integralmente pelo autor. Todo o conteúdo científico foi verificado contra as fontes primárias citadas, em conformidade com as diretrizes COPE (*Committee on Publication Ethics*) para uso de IA em publicações acadêmicas.
...
**a) A hidromedusa *Turritopsis dohrnii*.** Este cnidário é o único metazoário conhecido capaz de reverter completamente seu ciclo de vida por meio de **transdiferenciação**. O sequenciamento genômico comparativo de *T. dohrnii* e de sua congênere mortal *T. rubra* revelou expansões em genes associados a reparo de DNA, manutenção telomérica e silenciamento de alvos do complexo PRC2 (Pascual-Torner *et al.*, 2022). *Nota taxonômica:* a espécie foi originalmente descrita como *T. nutricula* por Piraino *et al.* (1996) e posteriormente reclassificada.

**b) *Hydra* — Senescência negligenciável por renovação contínua.** O pólipo *Hydra* mantém taxas de mortalidade e fertilidade constantes ao longo de observações superiores a quatro anos (Martinez, 1998; Schaible *et al.*, 2015), sustentadas por três populações de células-tronco permanentemente ativas.

**c) *Heterocephalus glaber* — O rato-toupeira-pelado.** A lei de Gompertz (1825), formulada originalmente para a mortalidade *humana*, postula que a taxa de mortalidade aumenta exponencialmente com a idade. Makeham (1860) acrescentou ao modelo uma constante de mortalidade independente da idade, resultando na lei de Gompertz-Makeham, amplamente adotada em estudos demográficos comparativos. O rato-toupeira-pelado é o primeiro mamífero documentado a violar essa generalização: sua taxa de mortalidade **não aumenta** após a maturidade sexual, permanecendo estável por mais de 30 anos (Ruby *et al.*, 2018; Buffenstein, 2008). Essa exceção é particularmente significativa por ocorrer em um mamífero, classe à qual os humanos pertencem.
...
**b) Planárias (*Schmidtea mediterranea*).** Regeneram um organismo completo a partir de 1/279 de seu volume, sustentadas por neoblastos pluripotentes (Reddien; Sánchez Alvarado, 2004).

**c) Peixe-zebra (*Danio rerio*).** Regenera tecido cardíaco funcional após remoção de até 20% do ventrículo (Poss *et al.*, 2002).
...
Estabelecidos o paradigma da *geroscience*, as evidências de senescência negligenciável na natureza e o conceito de amortalidade, as seções seguintes analisam os eixos mecanísticos específicos do envelhecimento humano — começando pelo dano genômico e atrito telomérico — que constituem os alvos moleculares das intervenções geroprotectoras em desenvolvimento.
...
O dano genômico cumulativo e o encurtamento telomérico aqui descritos convergem para um mesmo desfecho celular: a senescência. A seção seguinte analisa o fenótipo senescente, seu secretoma inflamatório e as estratégias farmacológicas para sua eliminação seletiva.
...
O acúmulo de células senescentes e seu secretoma inflamatório não constituem fenômenos isolados: sua persistência é amplificada pela desregulação das vias metabólicas de detecção de nutrientes. A seção seguinte examina o eixo mTOR/IGF-1, a autofagia e as intervenções geroprotectoras que modulam esses processos.
...
O declínio da autofagia e a depleção de NAD+ comprometem não apenas a reciclagem de organelas, mas também a capacidade das chaperonas moleculares de manter o enovelamento proteico correto. A seção seguinte examina a perda de proteostase e a patologia fibrilar resultante.
...
Paralelamente, evidências de senescência negligenciável em *Turritopsis dohrnii*, *Hydra* e *Heterocephalus glaber*, bem como a conservação genômica de programas regenerativos em vertebrados, indicam que a mortalidade biológica por envelhecimento, embora prevalente por razões evolutivas (Williams, 1957; Kirkwood, 1977; Medawar, 1952), não constitui imposição universal em todos os taxa. O conceito de amortalidade — proposto nesta revisão como recontextualização biogerontológica do termo de Mayer (2011), descrevendo a morte apenas por causas externas, sem senescência intrínseca — reflete o estado natural desses organismos e constitui horizonte teórico para a *geroscience* contemporânea.

Intervenções geroprotectoras — senolíticos (D+Q), rapalogues, precursores de NAD+, indutores de autofagia e reativação telomérica pulsátil — demonstraram resultados promissores em modelos pré-clínicos e ensaios clínicos iniciais. Entretanto, limitações substanciais permanecem: riscos de tumorigênese, resultados inconclusivos em humanos, baixa biodisponibilidade de compostos e ausência de desfechos clínicos padronizados para o envelhecimento. A tradução dessas abordagens para a clínica exigirá não apenas validação experimental rigorosa, mas também redefinições regulatórias — notadamente a classificação do envelhecimento como condição medicável pelas agências reguladoras.

As evidências revisadas sugerem que a mortalidade biológica atrelada à senescência pode não constituir uma imposição inelutável, embora a distância filogenética entre os organismos com senescência negligenciável e os humanos imponha cautela na extrapolação. O avanço em biomarcadores geriátricos, na compreensão das alterações genômicas associadas à idade e na modulabilidade dos mecanismos do envelhecimento aponta para a plausibilidade de se retardar o declínio funcional associado à idade e estender a duração do *healthspan* humano, com foco primário na mitigação das patologias crônicas não transmissíveis.

---

# REFERÊNCIAS

Acosta, J. C. *et al.* A complex secretory program orchestrated by the inflammasome controls paracrine senescence. **Nature Cell Biology**, v. 15, n. 8, p. 978-990, 2013. DOI: 10.1038/ncb2784.

Associação Médica Mundial. **Declaração de Helsinque**: princípios éticos para pesquisa médica envolvendo seres humanos. 64. ed. Fortaleza, 2013. Disponível em: https://www.wma.net/policies-post/wma-declaration-of-helsinki-ethical-principles-for-medical-research-involving-human-subjects/. Acesso em: 15 jan. 2026.

Baker, D. J. *et al.* Clearance of p16^Ink4a^-positive senescent cells delays ageing-associated disorders. **Nature**, v. 479, n. 7372, p. 232-236, 2011. DOI: 10.1038/nature10600.

Baur, J. A. *et al.* Resveratrol improves health and survival of mice on a high-calorie diet. **Nature**, v. 444, n. 7117, p. 337-342, 2006. DOI: 10.1038/nature05354.
...
Bernardes de Jesus, B. *et al.* Telomerase gene therapy in adult and old mice delays aging and increases longevity without increasing cancer. **EMBO Molecular Medicine**, v. 4, n. 8, p. 691-704, 2012. DOI: 10.1002/emmm.201200245.

Blagosklonny, M. V. Aging and immortality: quasi-programmed senescence and its pharmacologic inhibition. **Cell Cycle**, v. 5, n. 18, p. 2087-2102, 2006. DOI: 10.4161/cc.5.18.3288.

Brasil. Conselho Nacional de Saúde. **Resolução nº 466, de 12 de dezembro de 2012.** Aprova as diretrizes e normas regulamentadoras de pesquisas envolvendo seres humanos. Diário Oficial da União, Brasília, 13 jun. 2013. Disponível em: https://conselho.saude.gov.br/resolucoes/2012/Reso466.pdf. Acesso em: 15 jan. 2026.

Buffenstein, R. Negligible senescence in the longest living rodent, the naked mole-rat. **Journal of Comparative Physiology B**, v. 178, n. 4, p. 439-445, 2008. DOI: 10.1007/s00360-007-0237-5.

Burkewitz, K.; Zhang, Y.; Mair, W. B. AMPK at the nexus of energetics and aging. **Cell Metabolism**, v. 20, n. 1, p. 10-25, 2014. DOI: 10.1016/j.cmet.2014.03.002.

Camacho-Pereira, J. *et al.* CD38 dictates age-related NAD decline and mitochondrial dysfunction through an SIRT3-dependent mechanism. **Cell Metabolism**, v. 23, n. 6, p. 1127-1139, 2016. DOI: 10.1016/j.cmet.2016.05.006.

Campisi, J. Aging, cellular senescence, and cancer. **Annual Review of Physiology**, v. 75, p. 685-705, 2013. DOI: 10.1146/annurev-physiol-030212-183653.

Conboy, I. M. *et al.* Rejuvenation of aged progenitor cells by exposure to a young systemic environment. **Nature**, v. 433, n. 7027, p. 760-764, 2005. DOI: 10.1038/nature03260.

Covarrubias, A. J. *et al.* Senescent cells promote tissue NAD+ decline during ageing via the activation of CD38+ macrophages. **Nature Metabolism**, v. 2, n. 11, p. 1265-1283, 2020. DOI: 10.1038/s42255-020-00305-3.

Da Silva, R. A. *et al.* Slow and negligible senescence among testudines challenges evolutionary theories of senescence. **Science**, v. 376, n. 6600, p. 1466-1470, 2022. DOI: 10.1126/science.abl7811.

Egerman, M. A. *et al.* GDF11 increases with age and inhibits skeletal muscle regeneration. **Cell Metabolism**, v. 22, n. 1, p. 164-174, 2015. DOI: 10.1016/j.cmet.2015.05.010.

Eisenberg, T. *et al.* Induction of autophagy by spermidine promotes longevity. **Nature Cell Biology**, v. 11, n. 11, p. 1305-1314, 2009. DOI: 10.1038/ncb1975.

Finch, C. E. **Longevity, senescence, and the genome**. Chicago: University of Chicago Press, 1990. ISBN: 978-0-226-24888-2. Disponível em: https://press.uchicago.edu/ucp/books/book/chicago/L/bo3684531.html. Acesso em: 01 mar. 2026.

Finkel, T.; Serrano, M.; Blasco, M. A. The common biology of cancer and ageing. **Nature**, v. 448, n. 7155, p. 767-774, 2007. DOI: 10.1038/nature05985.

Fontana, L.; Partridge, L.; Longo, V. D. Extending healthy life span — from yeast to humans. **Science**, v. 328, n. 5976, p. 321-326, 2010. DOI: 10.1126/science.1172539.

Franceschi, C. *et al.* Inflamm-aging: an evolutionary perspective on immunosenescence. **Annals of the New York Academy of Sciences**, v. 908, p. 244-254, 2000. DOI: 10.1111/j.1749-6632.2000.tb06651.x.

Garmany, A. *et al.* Longevity leap: mind the healthspan gap. **npj Regenerative Medicine**, v. 6, n. 57, 2021. DOI: 10.1038/s41536-021-00169-5.

Gladyshev, V. N. Aging: progressive decline in fitness due to the rising deleteriome. **Aging Cell**, v. 15, n. 4, p. 594-602, 2016. DOI: 10.1111/acel.12480.

Gomes, A. P. *et al.* Declining NAD+ induces a pseudohypoxic state disrupting nuclear-mitochondrial communication during aging. **Cell**, v. 155, n. 7, p. 1624-1638, 2013. DOI: 10.1016/j.cell.2013.11.037.

Gompertz, B. On the nature of the function expressive of the law of human mortality. **Philosophical Transactions of the Royal Society of London**, v. 115, p. 513-583, 1825. DOI: 10.1098/rstl.1825.0026.

Green, D. R.; Galluzzi, L.; Kroemer, G. Mitochondria and the autophagy–inflammation–cell death axis in organismal aging. **Science**, v. 333, n. 6046, p. 1109-1112, 2011. DOI: 10.1126/science.1201940.

Guevara-Aguirre, J. *et al.* Growth hormone receptor deficiency is associated with a major reduction in pro-aging signaling, cancer, and diabetes in humans. **Science Translational Medicine**, v. 3, n. 70, 70ra13, 2011. DOI: 10.1126/scitranslmed.3001845.

Gurven, M.; Kaplan, H. Longevity among hunter-gatherers: a cross-cultural examination. **Population and Development Review**, v. 33, n. 2, p. 321-365, 2007. DOI: 10.1111/j.1728-4457.2007.00171.x.

Harman, D. Aging: a theory based on free radical and radiation chemistry. **Journal of Gerontology**, v. 11, n. 3, p. 298-300, 1956. DOI: 10.1093/geronj/11.3.298.

Harman, D. The biologic clock: the mitochondria? **Journal of the American Geriatrics Society**, v. 20, n. 4, p. 145-147, 1972. DOI: 10.1111/j.1532-5415.1972.tb00787.x.

Harrison, D. E. *et al.* Rapamycin fed late in life extends lifespan in genetically heterogeneous mice. **Nature**, v. 460, n. 7253, p. 392-395, 2009. DOI: 10.1038/nature08221.

Hayflick, L.; Moorhead, P. S. The serial cultivation of human diploid cell strains. **Experimental Cell Research**, v. 25, n. 3, p. 585-621, 1961. DOI: 10.1016/0014-4827(61)90192-6.

Houtkooper, R. H. *et al.* The secret life of NAD+: an old metabolite controlling new metabolic signaling pathways. **Endocrine Reviews**, v. 31, n. 2, p. 194-223, 2010. DOI: 10.1210/er.2009-0027.

Imai, S. *et al.* Transcriptional silencing and longevity protein Sir2 is an NAD-dependent histone deacetylase. **Nature**, v. 403, n. 6771, p. 795-800, 2000. DOI: 10.1038/35001622.

Jucker, M.; Walker, L. C. Self-propagation of pathogenic protein aggregates in neurodegenerative diseases. **Nature**, v. 501, n. 7465, p. 45-51, 2013. DOI: 10.1038/nature12481.

Justice, J. N. *et al.* Senolytics in idiopathic pulmonary fibrosis: results from a first-in-human, open-label, pilot study. **EBioMedicine**, v. 40, p. 554-563, 2019. DOI: 10.1016/j.ebiom.2018.12.052.

Kennedy, B. K. *et al.* Geroscience: linking aging to chronic disease. **Cell**, v. 159, n. 4, p. 709-713, 2014. DOI: 10.1016/j.cell.2014.10.039.

Kirkwood, T. B. L. Evolution of ageing. **Nature**, v. 270, n. 5635, p. 301-304, 1977. DOI: 10.1038/270301a0.

López-Otín, C. *et al.* The hallmarks of aging. **Cell**, v. 153, n. 6, p. 1194-1217, 2013. DOI: 10.1016/j.cell.2013.05.039.
...
Makeham, W. M. On the law of mortality and the construction of annuity tables. **Journal of the Institute of Actuaries**, v. 8, n. 6, p. 301-310, 1860. DOI: 10.1017/S204616580000126X.

Mannick, J. B. *et al.* mTOR inhibition improves immune function in the elderly. **Science Translational Medicine**, v. 6, n. 268, 268ra179, 2014. DOI: 10.1126/scitranslmed.3009892.

Martinez, D. E. Mortality patterns suggest lack of senescence in hydra. **Experimental Gerontology**, v. 33, n. 3, p. 217-225, 1998. DOI: 10.1016/S0531-5565(97)00113-7.

Mattison, J. A. *et al.* Caloric restriction improves health and survival of rhesus monkeys. **Nature Communications**, v. 8, 14063, 2017. DOI: 10.1038/ncomms14063.

Mayer, C. **Amortality**: the pleasures and perils of living agelessly. Londres: Vermilion, 2011. ISBN: 978-0-09-193936-6. Disponível em: https://www.penguin.co.uk/books/178935/amortality-by-mayer-catherine/9780091939366. Acesso em: 01 mar. 2026.

McCusker, C.; Gardiner, D. M. The axolotl model for regeneration and aging research. **Gerontology**, v. 57, n. 6, p. 565-571, 2011. DOI: 10.1159/000323761.

Medawar, P. B. **An unsolved problem of biology**. Londres: H. K. Lewis, 1952. Reimpresso em: Medawar, P. B. **The uniqueness of the individual**. Londres: Routledge, 2021. ISBN: 978-0-367-28123-6. Disponível em: https://www.routledge.com/The-Uniqueness-of-the-Individual/Medawar/p/book/9780367281236. Acesso em: 01 mar. 2026.

Mouchiroud, L. *et al.* The NAD+/sirtuin pathway modulates longevity through activation of mitochondrial UPR and FOXO signaling. **Cell**, v. 154, n. 2, p. 430-441, 2013. DOI: 10.1016/j.cell.2013.06.016.

Muñoz-Espín, D.; Serrano, M. Cellular senescence: from physiology to pathology. **Nature Reviews Molecular Cell Biology**, v. 15, n. 7, p. 482-496, 2014. DOI: 10.1038/nrm3823.

Nelson, G. *et al.* A senescent cell bystander effect: senescence-induced senescence. **Aging Cell**, v. 11, n. 2, p. 345-349, 2012. DOI: 10.1111/j.1474-9726.2012.00795.x.

Niedernhofer, L. J. *et al.* Nuclear genomic instability and aging. **Annual Review of Biochemistry**, v. 87, p. 295-322, 2018. DOI: 10.1146/annurev-biochem-062917-012239.

Nielsen, J. *et al.* Eye lens radiocarbon reveals centuries of longevity in the Greenland shark. **Science**, v. 353, n. 6300, p. 702-704, 2016. DOI: 10.1126/science.aaf1703.

Pascual-Torner, M. *et al.* Comparative genomics of mortal and immortal cnidarians unveils novel keys behind rejuvenation. **Proceedings of the National Academy of Sciences**, v. 119, n. 36, e2118763119, 2022. DOI: 10.1073/pnas.2118763119.

Piraino, S. *et al.* Reversing the life cycle: medusae transforming into polyps and cell transdifferentiation in *Turritopsis nutricula*. **Biological Bulletin**, v. 190, n. 3, p. 302-312, 1996. DOI: 10.2307/1543022.

Pomerantz, J. H.; Blau, H. M. Tumor suppressors: enhancers or suppressors of regeneration? **Development**, v. 140, n. 12, p. 2502-2512, 2013. DOI: 10.1242/dev.084210.

Poss, K. D.; Wilson, L. G.; Keating, M. T. Heart regeneration in zebrafish. **Science**, v. 298, n. 5601, p. 2188-2190, 2002. DOI: 10.1126/science.1077857.

Prigogine, I.; Nicolis, G. **Self-organization in nonequilibrium systems**: from dissipative structures to order through fluctuations. Nova York: Wiley, 1977. ISBN: 978-0-471-02401-9. Disponível em: https://www.wiley.com/en-us/Self-Organization+in+Nonequilibrium+Systems-p-9780471024019. Acesso em: 01 mar. 2026.

Rando, T. A.; Wyss-Coray, T. Asynchronous, contagious and digital aging. **Nature Aging**, v. 1, n. 1, p. 29-35, 2021. DOI: 10.1038/s43587-020-00015-1.

Reddien, P. W.; Sánchez Alvarado, A. Fundamentals of planarian regeneration. **Annual Review of Cell and Developmental Biology**, v. 20, p. 725-757, 2004. DOI: 10.1146/annurev.cellbio.20.010403.095114.

Ristow, M.; Zarse, K. How increased oxidative stress promotes longevity and metabolic health: the concept of mitochondrial hormesis (mitohormesis). **Experimental Gerontology**, v. 45, n. 6, p. 410-418, 2010. DOI: 10.1016/j.exger.2010.03.014.

Rose, M. R. **Evolutionary biology of aging**. Nova York: Oxford University Press, 1991. ISBN: 978-0-19-506133-6. Disponível em: https://global.oup.com/academic/product/evolutionary-biology-of-aging-9780195061338. Acesso em: 01 mar. 2026.

Roser, M.; Ortiz-Ospina, E.; Ritchie, H. Life expectancy. **Our World in Data**, 2023. Disponível em: https://ourworldindata.org/life-expectancy. Acesso em: 15 jan. 2026.

Ruby, J. G. *et al.* Naked mole-rat mortality rates defy Gompertzian laws by not increasing with age. **eLife**, v. 7, e31157, 2018. DOI: 10.7554/eLife.31157.

Ryu, D. *et al.* Urolithin A induces mitophagy and prolongs healthspan in *C. elegans* and increases muscle function in rodents. **Nature Medicine**, v. 22, n. 8, p. 879-888, 2016. DOI: 10.1038/nm.4132.

Salminen, A.; Kaarniranta, K. AMP-activated protein kinase (AMPK) controls the aging process via an integrated signaling network. **Ageing Research Reviews**, v. 11, n. 2, p. 230-241, 2012. DOI: 10.1016/j.arr.2011.12.005.

Sarkar, S. *et al.* Trehalose, a novel mTOR-independent autophagy enhancer. **Journal of Biological Chemistry**, v. 282, n. 8, p. 5641-5652, 2007. DOI: 10.1074/jbc.M609532200.

Schaible, R. *et al.* Constant mortality and fertility over age in *Hydra*. **Proceedings of the National Academy of Sciences**, v. 112, n. 51, p. 15701-15706, 2015. DOI: 10.1073/pnas.1521002112.

Skloot, R. **The immortal life of Henrietta Lacks**. Nova York: Crown Publishing, 2010. ISBN: 978-1-4000-5217-2. Disponível em: https://www.penguinrandomhouse.com/books/98663/the-immortal-life-of-henrietta-lacks-by-rebecca-skloot/. Acesso em: 01 mar. 2026.

Van Deursen, J. M. The role of senescent cells in ageing. **Nature**, v. 509, n. 7501, p. 439-446, 2014. DOI: 10.1038/nature13193.

Van Dyck, C. H. *et al.* Lecanemab in early Alzheimer's disease. **New England Journal of Medicine**, v. 388, n. 1, p. 9-21, 2023. DOI: 10.1056/NEJMoa2212948.

Verdin, E. NAD+ in aging, metabolism, and neurodegeneration. **Science**, v. 350, n. 6265, p. 1208-1213, 2015. DOI: 10.1126/science.aac4854.

Vermeij, W. P. *et al.* Restricted diet delays accelerated ageing and genomic stress in DNA-repair-deficient mice. **Nature**, v. 537, n. 7620, p. 427-431, 2016. DOI: 10.1038/nature19329.

Williams, G. C. Pleiotropy, natural selection, and the evolution of senescence. **Evolution**, v. 11, n. 4, p. 398-411, 1957. DOI: 10.1111/j.1558-5646.1957.tb02911.x.

Youle, R. J.; Narendra, D. P. Mechanisms of mitophagy. **Nature Reviews Molecular Cell Biology**, v. 12, n. 1, p. 9-14, 2011. DOI: 10.1038/nrm3028.

Zhu, Y. *et al.* The Achilles' heel of senescent cells: from transcriptome to senolytic drugs. **Aging Cell**, v. 14, n. 4, p. 644-658, 2015. DOI: 10.1111/acel.12344.
